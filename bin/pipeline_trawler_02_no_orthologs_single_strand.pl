...
# $Id: pipeline_trawler_02_no_orthologs_single_strand.pl,v 1.3 2009/04/27 11:49:10 haudry Exp $
        ...
        foreach my $motif (@motifs) {
            ...
            if($mot) {
                ...
                for(my $incr = 0; $incr<$size_mot; $incr++) {
                    ...
                    print STAT "$id\t$idmotif\t$motif\t$m_start\t0\t0\t$length_seq\t1\t$start_from_end\n";
...
#get the statistic about the conservation of motifs.
#sub get_stat_motif {
